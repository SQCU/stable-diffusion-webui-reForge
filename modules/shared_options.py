...
options_templates.update(options_section(('optimizations', "Optimizations", "sd"), {
    ...
    "s_min_uncond": OptionInfo(0.0, "Negative Guidance minimum sigma", gr.Slider, {"minimum": 0.0, "maximum": 867.0, "step": 0.01}, infotext='NGMS').link("PR", "https://github.com/AUTOMATIC1111/stable-diffusion-webui/pull/9177").info("skip negative prompt for some steps when the image is almost ready; 0=disable, higher=faster"),
    ...
    "s_max_uncond": OptionInfo(0.0, "Negative Guidance maximum sigma", gr.Slider, {"minimum": 0.0, "maximum": 867.0, "step": 0.01}, infotext='NGMaxS').link("kynkaat/guidance-interval", "https://github.com/kynkaat/guidance-interval").info("skip negative prompt for some steps when the image is only begun; 0=disable, lower=faster"),
...
options_templates.update(options_section(('sampler-params', "Sampler parameters", "sd"), {
    ...
    # New parameters for DPM++ samplers
